# EthioMart/src/distilbert_finetuner.py
...
# --- Configuration ---
MODEL_CHECKPOINT = "distilbert-base-multilingual-cased" # DistilBERT multilingual model
# Adjusted OUTPUT_DIR for DistilBERT
OUTPUT_DIR = Path(project_root / "models" / "distilbert_ner_fine_tuned") 
CONLL_FILE_PATH = Path(DATA_DIR.parent / "labeled" / "telegram_ner_data_rule_based.conll")

# Training arguments (can be adjusted)
TRAINING_ARGS = TrainingArguments(
    output_dir=str(OUTPUT_DIR / "training_logs"), # Save logs/checkpoints here
    ...
    logging_dir=str(OUTPUT_DIR / "runs"), # TensorBoard log directory
    ...
    # disable_tqdm=True, # Optional: uncomment if you prefer less verbose progress bars
)
